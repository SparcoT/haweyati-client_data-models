...
import 'package:haweyati_client_data_models/services/haweyati_service.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';
import '../const.dart';

class TripService extends HaweyatiRest<Trip>{
...
class HyperRequestService {
  ...
  Future<List> fetchNearby(LatLng cords,String vehicleId) async {
    var nearbyData =  NearbyData();
    var Hyperlocation =  HyperLocation();
    Hyperlocation.type = "Point";
    Hyperlocation.coordinates = [cords.longitude, cords.latitude];
    nearbyData.Hyperlocation = Hyperlocation;
    nearbyData.radius = 5000;
    nearbyData.lastUpdatedWithin = 24;
    nearbyData.metadata = { 'vehicle' : vehicleId};
